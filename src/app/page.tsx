            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-20">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/all-products" className="text-text-primary-gray">Air Force 1</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Huarache</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Air Max 90</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Air Max 95</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/all-products" className="text-text-primary-gray">All Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Custom Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Jordan Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Running Shoes</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/all-products" className="text-text-primary-gray">All Clothing</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Modest Wear</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Hoodies & Pullovers</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Shirts & Tops</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/all-products" className="text-text-primary-gray">Infant & Toddler Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Kid&#39;s Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Kid&#39;s Jordan Shoes</Link></li>
                  <li><Link href="/all-products" className="text-text-primary-gray">Kid&#39;s Basketball Shoes</Link></li>
                </ul>
              </div>
            </div>
          </div>
